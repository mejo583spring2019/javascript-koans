...
describe("About Higher Order Functions", function () {
  ...
  it("should use 'forEach' for simple iteration", function () {
    ...
    expect(msg).toEqual("falsetruefalse"); // this is broken. if you write "false true false" then the Koans says you're right and VS says there is an error. If you separate by commas, then VS is happy and Koans says you're wrong
    expect(numbers).toEqual([1, 2, 3]);
  });
